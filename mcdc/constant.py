...
SCORE_NET_CURRENT = 4
SCORE_TRACKS = 5
SCORE_SECOND_MOMENT = 6
SCORE_FLUX_MX = 7
SCORE_FLUX_MT = 8
SCORE_FLUX_MTX = 9
SCORE_CURRENT_MX = 10
SCORE_CURRENT_MT = 11
SCORE_CURRENT_MTX = 12
SCORE_SECOND_MOMENT_MX = 13
SCORE_SECOND_MOMENT_MT = 14
SCORE_SECOND_MOMENT_MTX = 15
SCORE_F0 = 16
SCORE_F1 = 17
SCORE_F2 = 18
SCORE_F3 = 19
...
# Surface type
SURFACE_LINEAR = 1 << 1
SURFACE_QUADRATIC = 1 << 2
SURFACE_PLANE_X = 1 << 3
SURFACE_PLANE_Y = 1 << 4
SURFACE_PLANE_Z = 1 << 5
SURFACE_PLANE = 1 << 6
SURFACE_CYLINDER_X = 1 << 7
SURFACE_CYLINDER_Y = 1 << 8
SURFACE_CYLINDER_Z = 1 << 9
SURFACE_SPHERE = 1 << 10
SURFACE_QUADRIC = 1 << 11
